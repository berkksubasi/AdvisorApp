...
const mainLaneDATA: MainLaneDataCollection = {
  ...
  9: {
    ...
    content: `Anahtar sözcükler: Hümanizm, kardeşlik, bağışlamak, kucaklamak ve yardımseverlik. 9 sayısı, sayılar evreninin son halkası ve zirvesidir; ayrıca ve en önemlisi, bu kudretin kaynağıdır. Mars yönetir, kova ve balık burçlarını etkiler. Idealizm, yaratıcılık, sevecenlik, anlayış, idrak, alçak gönüllülük, saygınlık, konu severlik, şefkatlik, iyimserlik etkileri vardır. Çok güçlü bir sayıdır, enerjisi yüksektir, hislidir, bütün sayıların özelliğini taşır. İş konularında kandırılabilirler, kendilerinden emin olsalar bile duygularını gizlerler. Elementi yoktur, bütün dünyaya hizmet etmek isterler. Nur eklidir, varoluşuna aşıktır, elinde bir şey kalmasa bile vermek ve paylaşmak isterler. Erdem, gerçeklik, geniş fikirlilik ve görüş açıklığına sahiptir, insanları kültürlerine ve ırklarına göre değerlendirmez. Hayatta bütün dersleri karşı cinsiyle ilişkiden alır, herkes tarafından sevilir, çekicidir. Uygun eğitim aldığında büyük bir sanatçı olabilir, kesin olmalıdır, denge ve duygusal kontrolünü beden farkındalığı ile geliştirmesi gerekmektedir, zihinleri hareketlidir.`,
    yapiciPotansiyeller: [
