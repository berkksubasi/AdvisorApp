...
const FonLaneResultView: React.FC<FonLaneResultProps> = ({ route }) => {
  ...
  const { user, title, description, chakraCounts } = route.params; // 'user' değerini al
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.descriptionContainer}>
          {/* <Text style={styles.title}>Kullanıcı: {name} {lastname}</Text> */}
...
export default FonLaneResultView;
